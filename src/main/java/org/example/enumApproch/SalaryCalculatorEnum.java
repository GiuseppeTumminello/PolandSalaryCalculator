...
public enum SalaryCalculatorEnum {
    ...
    SICKNESS_ZUS(
            gross -> gross.multiply(BigDecimal.valueOf(0.0245d)).setScale(2, RoundingMode.HALF_EVEN),
            "Sickness zus amount: "),
    TOTAL_ZUS(
    ...
    GROSS_YEARLY(gross -> gross.multiply(BigDecimal.valueOf(12)).setScale(2, RoundingMode.HALF_EVEN),
            "Yearly gross amount: "),
    TAX(gross -> {
    ...
    MONTHLY_GROSS(gross -> gross.multiply(BigDecimal.valueOf(12)).setScale(2, RoundingMode.HALF_EVEN),
            "Yearly gross amount: ");
