...
public class MenuSalaryCalculator {

    private final Scanner scanner;
    private final PrinterSalaryCalculator printerCalculator;

    public MenuSalaryCalculator() {
        this.scanner = new Scanner(System.in);
        this.printerCalculator = new PrinterSalaryCalculator();
