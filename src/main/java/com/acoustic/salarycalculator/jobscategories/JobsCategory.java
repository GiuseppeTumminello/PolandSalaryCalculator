...
public enum JobsCategory {
    ...
    IT(1, "It", Map.ofEntries(
            Map.entry(1, "DevOps Engineer"),
    ...
    FINANCE(2, "Finance", Map.ofEntries(
            Map.entry(1, "Depositary"),
    ...
    ENGINEER(3, "Engineer", Map.ofEntries(
            Map.entry(1, "Civil Engineer"),
    ...
    RESTAURANT(4, "Restaurant", Map.ofEntries(
            Map.entry(1, "Executive Chef"),
    ...
    AIRLINE(5, "Airline", Map.ofEntries(
            Map.entry(1, "Airline Captain"),
